...
public class AirplaneMovement : MonoBehaviour {
	...
	void Update () {
		...
		if(lookingPosition == AnswerPosition.Left) { // If looking to the left answer
		...
		} else if(lookingPosition == AnswerPosition.Middle) { // If looking to the middle answer
		...
		} else { // If looking to the right answer
	...
	void OnTriggerEnter(Collider other) {
		if(other.tag == "LeftLane") { // The player is looking at the left lane.
			lookingPosition = AirplaneMovement.AnswerPosition.Left;
		} else if(other.tag == "MiddleLane") { // The player is looking at the middle lane.
			lookingPosition = AirplaneMovement.AnswerPosition.Middle;
		} else if(other.tag == "RightLane") { // The player is looking at the right lane.
